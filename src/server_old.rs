...
use crate::database_types::{self, VirtualTableID};
...
pub struct FetchVirtualTables {
    pub vtables: Vec<database_types::VirtualTable>
} 
...
pub struct FetchItems {
    pub items: HashMap<String, database_types::Offer>,
} 
...
pub struct FetchVirtualTableNewOrders {
    pub orders: Vec<database_types::Order>
} 

impl FetchVirtualTableNewOrders {

    pub fn from_db(vtable: database_types::VirtualTableID) -> Result<Self, String> {
...
pub struct RequestFinishOrder {
    pub order_id: database_types::OrderID
}

impl RequestFinishOrder {

    pub fn send_request(self) -> Result<VirtualTableID, String> {
...
pub struct RequestDeleteVirtualTable {
    pub table_id: database_types::VirtualTableID
}
